...
<body>
    ...
    @csrf
    <div class="col ms-5 ps-5" class="btn btn-secondary btn-lg rounded-pill d-inline-block ms-5"><label type="button">Importer vos fichiers:</label>
    <input type="file" name="file" accept=".xlsx,.xls" class="btn btn-secondary btn-lg rounded-pill d-inline-block ms-5" required>
    <button type="submit" class="btn btn-secondary btn-lg rounded-pill d-inline-block ms-5"  type="button">Importer</button></div>
